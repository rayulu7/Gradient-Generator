...
class GradientGenerator extends Component {
  ...
  onChangeFromColor = fromColor => {
    this.setState({
      fromColorInput: fromColor.target.value,
    })
  }

  onChangeToColor = toColor => {
    this.setState({
      toColorInput: toColor.target.value,
    })
  }
          ...
          <GradientDirectionList>
            {gradientDirectionsList.map(eachDirection => (
              <GradientDirectionItem
                ...
                clickGradientDirectionItem={this.onClickGradientDirection}
